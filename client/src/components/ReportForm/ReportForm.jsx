...
export default function ReportForm() {
  ...
  const fetchIssue = async () => {
    try {
      ...
      const index = ISSUE_TYPES.findIndex(
        (item) => item.label === issue.category,
      );
  ...
  const handleSubmit = async () => {
    try {
      ...
      const selectedIssue = ISSUE_TYPES[selectedType];

      const formData = new FormData();

      formData.append("title", selectedIssue.label);

      formData.append("description", description);

      formData.append("category", selectedIssue.label);
      ...
      if (isEditMode) {
        res = await api.patch(`/problems/${id}`, formData, {
          headers: {
                ...
                <div className="form-group">
                  ...
                  <div className="coords-row">
                    <input
                      ...
                      value={location ? location.lat : "Fetching..."}
                      readOnly
                    />
                    ...
                    <input
                      type="text"
                      className="coord-input"
                      value={location ? location.lng : "Fetching..."}
                      readOnly
                    />
                  </div>
                </div>
                  ...
                  {recentIssues.map((issue) => (
                    <div key={issue._id} className="recent-item">
                      ...
                      <div className="recent-info">
                        <div className="recent-name">{issue.title}</div>

                        <div className="recent-meta">{issue.category}</div>
                      </div>
